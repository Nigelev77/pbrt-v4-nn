...
namespace pbrt
{
    ...
    struct OutputRayWorkItem
    {
        ...
        int prevEvent;
        int nextEvent;
        //TODO: Either I just output from the PixelSampleState, or I create a separate 
        // ray output if I want to consider logging intermediate values too
