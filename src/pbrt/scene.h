...
namespace pbrt
{
    ...
    //TODO: Put this to be a commandline option or part of the file
    constexpr int NUMBER_OF_ORIENTATIONS = 1;
    ...
    struct CameraSceneEntity : public SceneEntity
    {
        ...
        Point3f look;
        Vector3f up;
        //INFO: Easiest way for now without having to change the parsing logic
        // Is to define a set distance k away from look direction as the centre of a sphere
        // And sample positions on that sphere, and change the orientations accordingly.
    ...
    private:
        ...
        std::vector<CameraSceneEntity> cameras;
